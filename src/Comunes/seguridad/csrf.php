...
class csrf {
    /**
     * Genera un token CSRF y lo guarda en $_SESSION['csrf_token'] 
     * si aún no existe. Devuelve siempre el valor final del token.
     */
    ...
    /**
     * Valida que, si el método es POST, el token enviado por formulario 
     * coincida exactamente con el guardado en sesión. 
     ...
     * Úsalo dentro de tu <form> para que se envíe en cada petición POST.
     */
