<?php
  ...
  if ($_SESSION['tipo_rol'] !== 'ADMIN_TRAMITE') {
    header("Location: ../../loggin.php");
    session_destroy();
    session_unset();
    exit;
        ...
        <div class="sidebar-logo">
          <!-- Logo Header -->
            <div class="logo-header">
              <a href="dashboard_process.php" class="logo">
                  ...
                  <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                      <li>
                        <div class="user-box">
                          <div class="avatar-lg">
                            <img src="../../assets/img/profile.jpg" alt="image profile" class="avatar-img rounde"/>
                          </div>
                          <div class="u-text">
                ...
                <div class="card card-round">
                  <div class="card-body">
                    <div class="card-head-row card-tools-still-right">
                      <div class="card-title">Asignación de Tramites</div>
                    ...
                    <div class="card-list py-4">
                      <div class="item-list">
                        ...
                        <div class="info-user ms-3">
                          ...
                          <div class="status">Tramite Asignado</div>
                        </div>
                      ...
                      <div class="item-list">
                        ...
                        <div class="info-user ms-3">
                          <div class="username">Abogado 4</div>
                          <div class="status">Tramite Asignado</div>
                        </div>
                        <button class="btn btn-icon btn-link op-8 me-1">
                          <i class="far fa-envelope"></i>
              ...
              <div class="col-md-8">
                <div class="card card-round">
                  <div class="card-header">
                    <div class="card-head-row card-tools-still-right">
                      <div class="card-title">Historial Tramites Asignados</div>
                      <div class="card-tools">
                        <div class="dropdown">
                          <button
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="#">Abogado</a>
                            <a class="dropdown-item" href="#">Tipo Tramite</a>
                            <a class="dropdown-item" href="#">Estado de Tramite</a>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <table class="table align-items-center mb-0">
                        <thead class="thead-light">
                          <tr>
                            ...
                            <th scope="col" class="text-end">Fecha Inicio</th>
                            <th scope="col" class="text-end">Fecha Final</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-end">Mar 19, 2020, 2.45pm</td>
                            <td class="text-end">
                              <span class="badge badge-success">Embargo</span>
                            </td>
                          </tr>
                          <tr>
                            <th scope="row">
